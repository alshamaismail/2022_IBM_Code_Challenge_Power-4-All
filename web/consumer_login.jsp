<%-- 
    Document   : consumer_login
    Created on : 5 May, 2022, 6:01:26 PM
        ...
        <div class="border2">
            ...
            <%
                    if(request.getParameter("consumernumber")!=null)
                    {
                        ...
                        PreparedStatement stmt=conn.prepareStatement("select * from consumer where consumer_no=? and password=?");
                        ...
                        if(rs.next())
                        {
                                response.sendRedirect("consumer_page.jsp?consumernumber="+consumernumber);
                        }
                        else
                        {%>
